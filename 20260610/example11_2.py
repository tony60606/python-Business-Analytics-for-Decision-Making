...
print(f'lower_whisker ={lower_whisker},upper_bound ={upper_whisker}')
print('='*10)
# 3. 開始繪圖 
...
for text,y_pos in annotations.items() :
    ax.text(x_offset,y_pos,text,verticalalignment='center',color='red',fontweight='bold',fontsize=8)

# 以圖例形式將 iqr 放在右上角
ax.text(0.9,0.9,f'IQR={iqr:,.0f}',transform=ax.transAxes,horizontalalignment='right',verticalalignment='top',fontsize=15)
#
plt.tight_layout()
plt.show()