...
# print(sessions['campaign'].value_counts())
print("="*30)
# 6-2.查看 device 欄位的類別分布,以百分比方式顯式
result = sessions['device'].value_counts(normalize=True)*100
