...
by_payment_type = facts.groupby(facts['payment_type'])['line_revenue'].agg( 
    訂單數 = 'count',
    平均客單價 = 'mean',
    營收總計 = 'sum',
    中位數 = 'median',
...
#只看小數一位
by_payment_type=by_payment_type.round(1)
#輸出為temp2.csv 
by_payment_type.to_csv('temp2.csv')
